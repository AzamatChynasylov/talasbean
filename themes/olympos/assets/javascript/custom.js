...
$(document).ready(function ($) {
	...
	// 	$("html, body").animate({
	// 		scrollTop: $('#our-family').offset().top
	// 	}, 2000);
	// 	return false;
	// });
	...
	function heightses() {
		...
		$(".service-desc h3").height('auto').equalHeights();
		$(".s-equipment h3").height('auto').equalHeights();
		$(".carousel-text h3").height('auto').equalHeights();
		$(".carousel-text p").height('auto').equalHeights();
		$(".blog-company .caption h3").height('auto').equalHeights();
		$(".blog-company .caption .desc").height('auto').equalHeights();
	}
